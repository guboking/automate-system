...
本系统集成了以下 Skills，位于 `.claude/skills/` 目录：

### 8.1 PDF Deep Reader (`pdf-reader.md`)

深度解析研报、政策文档、技术文档。

**触发词：** 「读这个PDF」「分析研报」「解读文档」

**能力：**
- 自动识别文档类型（研报/政策/技术/财报）
- 套用对应分析框架
- 与 `CLAUDE_MEMORY.md` 交叉验证

### 8.2 投资分析框架 (`investment-analysis.md`)
...
### 8.3 补剂评估框架 (`supplement-analysis.md`)

三维度评估保健品/补剂。

**触发词：** 「补剂评估」「XXX能吃吗」「成分分析」
...
| 文件 | 用途 |
|------|------|
| `CLAUDE_MEMORY.md` | 当前持仓观点、板块看法 |
| `核心选股逻辑精炼版.md` | 历史分析框架参考 |
| `stock_cache/` | 股票数据缓存 |
| `.claude/skills/` | 分析框架模板 |

**联动规则：**
- 每次分析自动参考 `CLAUDE_MEMORY.md`
- 新结论可更新记忆文件
- 与历史观点冲突时主动标注
